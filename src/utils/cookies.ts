...
export const setCookies = (context: Context, opt: { key: string; value: string; expires?: Date }) => {
  const options = { path: '/' }
...
export const setAuthCookies = (context: Context, opt: { key: string; value: string }) => {
