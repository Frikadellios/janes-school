...
import { FormDataSchema } from '@/data/schema'
      ...
      <form className="mt-12" onSubmit={handleSubmit(processForm)}>
        {currentStep === 0 && (
          ...
          >
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600 dark:text-white">Provide your personal details.</p>
        ...
        {currentStep === 1 && (
          <motion.div
            ...
            transition={{ duration: 0.3, ease: 'easeInOut' }}
          >
            <h2 className="text-base font-semibold leading-7 text-gray-900 dark:text-white">Address</h2>
            <p className="mt-1 text-sm leading-6 text-gray-600 dark:text-white">Address where you can receive mail.</p>
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                <label htmlFor="street" className="block text-sm font-medium leading-6 text-gray-900 dark:text-white">
                  Street address
                </label>
                <div className="mt-2">
                  <input
              ...
              <div className="sm:col-span-2">
                <label htmlFor="zip" className="block text-sm font-medium leading-6 text-gray-900 dark:text-white">
                  ZIP / Postal code
                </label>
                <div className="mt-2">
                  <input
        ...
        {currentStep === 2 && (
          <>
            <h2 className="text-base font-semibold leading-7 text-gray-900 dark:text-white ">Complete</h2>
            <p className="mt-1 text-sm leading-6 text-green-500 ">Thank you for your submission.</p>
          </>
        )}
      </form>
